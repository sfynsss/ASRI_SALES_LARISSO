...
public class AdapterKunjunganCustomer extends ArrayAdapter<String> {
    ...
    public AdapterKunjunganCustomer(Activity context, ArrayList<String> kode_customer, ArrayList<String> nama_customer, ArrayList<String> alamat_customer, ArrayList<String> kode_aktivasi_customer, ArrayList<String> email_customer, ArrayList<String> otoritas, OnEditLocationListener generate_btn, OnEditLocationListener tambah) {
        super(context, R.layout.adapter_kunjungan_customer, kode_customer);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null){
            ...
            v = layoutInflater.inflate(R.layout.adapter_kunjungan_customer, null, true);
