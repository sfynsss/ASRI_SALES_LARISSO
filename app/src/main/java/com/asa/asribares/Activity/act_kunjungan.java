...
public class act_kunjungan extends AppCompatActivity {
...
//        });
        ...
        btn_kunjungan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new SweetAlertDialog(act_kunjungan.this, SweetAlertDialog.SUCCESS_TYPE)
                        ...
                        .setCancelClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                try {
                                    ...
                                    showDialog(act_kunjungan.this, "No Scanner Found", "Download a scanner code activity?", "Yes", "No").show();
                                }
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            @Override
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                it = new Intent(act_kunjungan.this, act_data_customer.class);
        ...
        dt_start.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(act_kunjungan.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        getDataKunjungan.enqueue(new Callback<BaseResponse<kunjungan>>() {
            ...
            public void onResponse(Call<BaseResponse<kunjungan>> call, Response<BaseResponse<kunjungan>> response) {
                if (response.isSuccessful()) {
                    ...
                    kunjunganListView = new AdapterKunjungan(act_kunjungan.this, kd_cust, nm_cust, tgl_kunjungan);
                    listView.setAdapter(kunjunganListView);
                } else {
                    SweetAlertDialog pDialog = new SweetAlertDialog(act_kunjungan.this, SweetAlertDialog.ERROR_TYPE);
            ...
            public void onFailure(Call<BaseResponse<kunjungan>> call, Throwable t) {
                Toasty.error(act_kunjungan.this, t.getMessage() + "", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        if (requestCode == 0) {
            ...
            if (resultCode == 1) {
                ...
                insertKunjungan.enqueue(new Callback<BaseResponse>() {
                    ...
                    public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                        if (response.isSuccessful()) {
                            Toasty.success(act_kunjungan.this, response.message()+"", Toast.LENGTH_SHORT).show();
                            getData();
                        } else {
                            SweetAlertDialog pDialog = new SweetAlertDialog(act_kunjungan.this, SweetAlertDialog.ERROR_TYPE);
                            pDialog.getProgressHelper().setBarColor(Color.parseColor("#A5DC86"));
